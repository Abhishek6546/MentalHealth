          ...
          <div className="text-center mb-8">
            {/* <div className="flex items-center justify-center space-x-3 mb-6">
              <div className="relative">
                <Heart className={`h-12 w-12 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'} animate-pulse`} />
                <Sparkles className={`h-4 w-4 ${isDarkMode ? 'text-yellow-400' : 'text-yellow-500'} absolute -top-1 -right-1 animate-bounce`} />
              </div>
              <div>
